...
const legendOptions = {
	legend: {
		...
		data: [
			{
				name: '今日',
				icon: 'image://data:image/png;base64,',
			},
			{
				name: '工作日',
				icon: 'image://data:image/png;base64,',
			},
			{
				name: '周末',
				icon: 'image://data:image/png;base64,',
			},
		],
		textStyle: {
			color: '#ffffff',
