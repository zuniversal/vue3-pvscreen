...
export const renderSelectItem = ({options}) => options?.map((item) => <el-option key={item.value} {...item} label={item.value} >{item.label}</el-option>)
export const renderRadioItem = ({options}) => options?.map((item) => <el-radio key={item.value} {...item} label={item.value} >{item.label}</el-radio>)
export const renderCheckboxItem = ({options}) => options?.map((item) => <el-checkbox key={item.value} {...item} label={item.value} >{item.label}</el-checkbox>)